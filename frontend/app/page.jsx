...
export default function Home() {
  const studyTools = useStudyTools();
  ...
  return (
    <div className={styles.container}>
        ...
        {isConversationLoading ? (
          ...
          <div className={styles.emptyState}>
            <div className={styles.emptyStateHeader}>
              <h1 className={styles.welcomeText}>What would you like to learn today?</h1>
            </div>
            <ChatInput
              variant="centered"
              inputValue={inputValue}
          ...
          <>
            ...
            >
              <div className={styles.messagesArea}>
                {messages.map((msg) => (
                  <ChatMessage key={msg.id} message={msg} onFlashcards={studyTools.generateFlashcards} onQuiz={studyTools.generateQuiz} onSummary={studyTools.generateSummary} />
                ))}
      ...
      <StudyToolsModal
        isOpen={studyTools.isOpen}
        mode={studyTools.mode}
        isLoading={studyTools.isLoading}
        error={studyTools.error}
        result={studyTools.result}
        sourceName={studyTools.sourceName}
        onClose={studyTools.closeModal}
      />
    </div>
  );
}
